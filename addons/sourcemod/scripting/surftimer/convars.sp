...
void CreateConVars()
{
	...
	g_hStagePreSpeed = CreateConVar("ck_prestage_speed", "270.0", "The maximum prespeed for stage start zones. 0.0 = No cap", FCVAR_NOTIFY, true, 0.0, true, 3500.0);
